...
########################### EXAMEN ###############################################
    ...
    def self.obtener_monedas(m)
      arrayValor = Array.new
      @@banca.caja.each { |moneda| arrayValor << moneda if moneda.tipo_m == m}
      return arrayValor 
    end
...
#      puts @@tablero
      ...
      #Unidad Monetaria
      puts "\n Metodo obtener_monedas: Tipo argumento ----------------------------"
      puts obtener_monedas(Tipo_moneda::EURO_ESP)
      puts obtener_monedas(Tipo_moneda::EURO_IT)
      puts obtener_monedas(Tipo_moneda::EUROS2_ESP)
      puts obtener_monedas(Tipo_moneda::CTS50_ESP)
