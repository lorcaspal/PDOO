  ...
  class Tablero
    ...
    def inicializar
      @casillas = Array.new
        ...
        #Casilla de salida
        @casillas << (Casilla.noCalle(0, TipoCasilla::SALIDA))
        ...
        @casillas << (Casilla.noCalle(4, TipoCasilla::SORPRESA))
        ...
        #Casilla tipo Juez
        @casillas << (Casilla.noCalle(7, TipoCasilla::JUEZ))
        
        #Casilla tipo calle
        @casillas << (Casilla.new(8, 100, TipoCasilla::CALLE,  TituloPropiedad.new('Calle Perla', 50,  -0.2, 150, 250)))
        
        #Casilla tipo Carcel
        @casillas << (Casilla.noCalle(9, TipoCasilla::CARCEL))
        
        #Casilla tipo Sorpresa
        @casillas << (Casilla.noCalle(10, TipoCasilla::SORPRESA))
        ...
        #Casilla tipo Sorpresa
        @casillas << (Casilla.noCalle(14, TipoCasilla::SORPRESA))
        
        #Casilla tipo Parking
        @casillas << (Casilla.noCalle(15, TipoCasilla::PARKING))
        ...
        @casillas << (Casilla.noCalle(18, TipoCasilla::IMPUESTO))
